...
class TestScenarioPlayer:
    ...
    #         operation_dict = screenshot_operation_dict[Placeholder.OPERATION]
    #         if operation_dict:
    #             step_num = int(operation_dict[Placeholder.STEP_NO])
    #             step = steps[step_num]
    #             action = operation_dict[Placeholder.ACTION]
    #             element_num = operation_dict[Placeholder.ELEMENT_NUM]
    #             element_input = operation_dict[Placeholder.ELEMENT_INPUT]
    #             scroll_direction = operation_dict[Placeholder.SCROLL_DIRECTION]
    #             new_step_history_flag = True
    #
    #             for step_history in step_history_list:
    #                 if step_num == int(step_history[Placeholder.STEP_NO]):
    ...
    # @staticmethod
    # def get_action_steps_from_bug(bug, test_scenario_no=0):
    #     # id_scenarios_dict = bug.convert_scenarios_to_dict()
    #     action_steps_list = []
    #     for test_scenario in bug.description.scenarios:
    #         steps = []
    #         for test_scenario

    # @staticmethod
    # def play_test_scenario(steps, app_keyword='firefox', with_original_gui=True, with_history=True,
    #                        with_previous_gui=True):
    #     # id_scenarios_dict = bug.get_id_scenarios_dict()
    #     # bug_id = bug.id
    #     # scenario = id_scenarios_dict[Placeholder.SCENARIOS][0]
    ...
    #     screenshot_operation_list = []
    #     output_dict = {
    #         Placeholder.APP_DIR: None,
    #         # Placeholder.SCENARIO: scenario,
    #         Placeholder.STEPS: steps,
    #         Placeholder.SCREENSHOT_OPERATION_LIST: screenshot_operation_list,
    #     }
    ...
    #             base64_image, base64_image_with_nums, num_coord_dict = TestScenarioPlayer. \
    ...
    #                 if not with_original_gui:
    #                     base64_previous_image = None
    #             answer, messages = ElementLocator.locate_element(steps, base64_image_with_nums, base64_image,
    #                                                              player_history,
    ...
    #             # print(type(answer))
    #
    #             action, element_coord, element_input, scroll_direction, steps_completion = ElementLocator.process_ans(
    #                 answer,
    #                 num_coord_dict)
    ...
    #         screenshot_name = f"{Placeholder.SCREENSHOT}_{screenshot_num}"
    #         TestScenarioPlayer.capture_and_process_screenshot(
    #             app_directory,
    #             screenshot_name)
    #         screenshot_operation_dict = {
    #             Placeholder.SCREENSHOT: str(Path(app_directory, f"{screenshot_name}.png")),
    ...
    #             Placeholder.SCREENSHOT_OPERATION_LIST: screenshot_operation_list,
    #         }
    #         FileUtil.dump_json(Path(app_directory, f"{Placeholder.PLAYER_OUTPUT}.json"), output_dict)
...
class ElementLocator:
    ...
    def question(text_value, base64_image_with_nums, base64_image=None,
        ...
        # if references:
        #     text_input = LLMUtil.TEXT_INPUT.format(text_value=references)
        #     # print(text_input)
        #     # text_input = json.loads(text_input)
        #     # print(type(text_input))
        #     question.append(text_input)
    ...
    def locate_element(step, base64_image_with_nums, base64_image=None,
        ...
        # image_number = 1
        # text_value = f"{Placeholder.STEP}: {step}\n"
        text_value = f"{step}\n"
    ...
    # @staticmethod
    # def locate_element(current_step_no, steps, base64_image_with_nums, base64_image=None,
    ...
    #     print(messages)
    #     image_number = 1
    #     text_value = f"{steps[current_step_no]}\n" \
    #                  f"I want to do this step, please identify which element I " \
    #                  f"should operate and which action I should use based on the specific GUI. \n"
    #     if player_history and base64_previous_image:
    #         text_value = text_value + f"No. {image_number} GUI is the previous GUI. \n"
    #         image_number = image_number + 1
    #     if player_history and base64_previous_image_with_nums:
    ...
    #                                   f'please summarize the wrong attempts based on {Placeholder.STEP_HISTORY_LIST} and ' \
    #                                   f'try to operate the element by using other possible coordinate numbers.'
    #         # f'First, based on the current GUI, determine whether {Placeholder.OPERATION} in {
    #         # Placeholder.PREVIOUS_STEP_HISTORY} has completed the corresponding {Placeholder.STEP}. ' \ f'If it has
    #         # been completed, proceed to the next step. ' \ f'If it has not been completed, attempt other operations
    #         # to complete the corresponding step. \n' \
    #     else:
    #         text_value = text_value + "Please identify which element I should operate and " \
    #                                   "which action I should use based on the current GUI. "
    #
...
#
#     @staticmethod
#     def get_player_history(output_dict, with_previous_gui=True):
#         step_history_list = []
#         previous_step_history = None
#
#         steps = output_dict[Placeholder.STEPS]
...
#
#     @staticmethod
#     def play_test_scenario(steps, bugs=None, app_keyword='firefox', with_original_gui=True, with_history=True,
#                            with_references=True,
#                            with_previous_gui=True, with_messages=True):
#         screenshot_operation_list = []
#         output_dict = {
#             Placeholder.APP_DIR: None,
#             # Placeholder.SCENARIO: scenario,
...
#         json_format_request = f"Please give me the answer in a json format: {Placeholder.ELEMENT_LOCATOR}"
#
#         session_prompt = (
#                 introduction + "\n" +
#                 steps + "\n" +
...
#         @todo
#         """
#         session_prompt = ElementLocator.get_session_prompt(steps)
#         qa_pairs = None
#         if with_instances:
#             qa_pairs = ElementLocator.convert_instances_into_qa_pairs(with_instances)
#         messages = LLMUtil.get_messages(session_prompt, qa_pairs)
...
#         #     question.append(text_input)
#
#         image_input_list = [previous_gui_encode, previous_gui_with_nums_encode, base64_image, base64_image_with_nums]
#         for image_input in image_input_list:
#             if image_input:
#                 image_input = LLMUtil.IMAGE_BASE64_INPUT.format(base64_image=image_input, img_detail=img_detail)
#                 image_input = json.loads(image_input)
...
#                        player_history=None, base64_previous_image_with_nums=None, base64_previous_image=None,
#                        messages=None,
#                        with_instances=False, references=None, img_detail="high"):
#         if messages is None:
#             messages = ElementLocator.get_initial_messages(steps, with_instances)
#         # print(messages)
#
...
#     @staticmethod
#     def process_ans(answer_dict, num_coord_dict):
#         step_no = answer_dict.get(Placeholder.STEP_NO)
...
#         #     else:
#         #         raise ValueError(f"Invalid literal for boolean: '{steps_completion}'")
#         return step_no, action, element_coord, element_input, scroll_direction, steps_completion
#
#         # return action, element_coord, element_input, scroll_direction, steps_completion
#
#     @staticmethod
