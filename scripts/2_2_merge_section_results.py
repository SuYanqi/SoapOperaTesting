...
if __name__ == "__main__":
    ...
    sec_filenames = FileUtil.get_file_names_in_directory(Path(DATA_DIR, app, section_foldername), 'json')
    ...
    FileUtil.dump_json(Path(filepath, f"bug_id_{section_foldername}_ans_pairs.json"), sec_results)
